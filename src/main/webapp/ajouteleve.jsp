                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nom" name="Nom" placeholder="Saisisser le nom">&nbsp;<i class="fa fa-warning"></i>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="Date_Naiss" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="prenom" name="Prenom" placeholder="Saisisser le prénom">&nbsp;<i class="fa fa-warning"></i>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nom" name="NomTuteur" placeholder="Saisisser le nom du tuteur">&nbsp;<i class="fa fa-warning"></i>
                                                </div>
                                                <div class="form-group">
