...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 03 Décembre 2017 à 02:24
...
INSERT INTO `eleve` (`IdEleve`, `matricule`, `Nom`, `Prenom`, `Date_Naiss`, `adresses`, `telephone`, `dette`, `status`, `quantine`, `nationalite`, `sexe`, `email`, `Date_inscription`, `IdTuteur`) VALUES
(2, 'J001', 'Gnali', 'Ines', '1992-05-24', '25Av du Kouilou Arr N°1', '781776113', 5000, 'Attente', 500, 'Ango-Congolaise', 'Feminin', 'gnali_ines@hotmail.com', '2017-09-26', 1);
...
CREATE TABLE IF NOT EXISTS `maitre` (
  `MatriculeMaitre` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`MatriculeMaitre`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
INSERT INTO `matiere` (`IdMatiere`, `designation`, `IdProfesseur`, `Cod_matiere`) VALUES
(2, 'Francais', 1, 1);
...
CREATE TABLE IF NOT EXISTS `matiereclasse` (
  `IdMClasse` int(11) NOT NULL AUTO_INCREMENT,
  `Libelle` varchar(50) NOT NULL,
  `Coef` int(11) NOT NULL,
  `Mat_Code` int(11) NOT NULL,
  `IdClasse` int(11) NOT NULL,
  `IdMatiere` int(11) NOT NULL,
  PRIMARY KEY (`IdMClasse`),
  KEY `IdClasse` (`IdClasse`),
...
INSERT INTO `professeur` (`IdProfesseur`, `nom_prenom`, `Code_prof`) VALUES
(1, 'Francois miterand', 1);
...
INSERT INTO `tuteur` (`IdTuteur`, `tut_code`, `nom_prenom`, `telephone`, `Email`, `Adresse`, `Relation`, `profession`) VALUES
(1, 'T01', 'Gnali Edwige', '6214283', 'gnali_ines@yahoo.fr', '125Av du Kouilou Arr n°1', 'Mere', 'CEO de la NP');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `groupe_utilisateur` int(100) NOT NULL,
...
(1, 'gnali ines', 'admin', 'admin', '2017-08-02', 0, 1);
...
--
ALTER TABLE `note`
  ADD CONSTRAINT `note_ibfk_1` FOREIGN KEY (`IdMatiereClasse`) REFERENCES `matiere` (`IdMatiere`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `note_ibfk_2` FOREIGN KEY (`IdEleve`) REFERENCES `inscrit` (`IdInscrit`) ON DELETE CASCADE ON UPDATE CASCADE;
